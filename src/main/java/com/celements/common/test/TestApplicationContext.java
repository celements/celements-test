 ...
 * <code>getResource</code> and <code>getResourceAsStream</code> methods to access
 * resources. Useful for running tests without a real live container.
 * 
 * @version TestApplicationContext.java fpichler copied from com.xpn.xwiki.test
 */
